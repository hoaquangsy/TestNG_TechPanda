...
public class TC1 {
  ...
  public void Test() {
	  WebDriverManager.chromedriver().setup();
	    ...
	    driver.findElement(By.cssSelector("#email_address")).sendKeys("SyHq1@gmail.com");
    	...
    	String nameString=driver.findElement(By.cssSelector("body > div > div > div.main-container.col2-left-layout > div > div.col-main > div > div.my-wishlist > ul > li > ul > li > span")).getText();
    	String execp="Your Wishlist has been shared."
    	assertEquals(nameString,execp);
